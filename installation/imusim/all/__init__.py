...
for loader, modname, ispkg in pkgutil.walk_packages([path]):
    if modname.startswith('imusim') \
            ...
            and not modname.startswith('imusim.visualisation') \
            and not modname.startswith('imusim.capture') \
            and not modname.startswith('imusim.testing') \
            and not modname.startswith('imusim.io') \
